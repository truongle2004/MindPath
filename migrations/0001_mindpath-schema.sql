...
CREATE UNIQUE INDEX "idx_user_badges_unique" ON "user_badges" USING btree ("user_id","badge_id");--> statement-breakpoint
CREATE INDEX "idx_card_reviews_card_id" ON "card_reviews" USING btree ("card_id");--> statement-breakpoint
CREATE INDEX "idx_card_reviews_user_date" ON "card_reviews" USING btree ("user_id","reviewed_at" DESC NULLS LAST);--> statement-breakpoint
CREATE INDEX "idx_cards_deck_id" ON "cards" USING btree ("deck_id");--> statement-breakpoint
CREATE INDEX "idx_cards_due" ON "cards" USING btree ("due") WHERE "cards"."state" != 'new';--> statement-breakpoint
CREATE INDEX "idx_pomodoro_user_id" ON "pomodoro_sessions" USING btree ("user_id","started_at" DESC NULLS LAST);